...
.stApp {
    min-height: 100vh;
    background:
        radial-gradient(circle at 10% 15%, rgba(88, 70, 220, 0.20), transparent 28%),
        radial-gradient(circle at 88% 12%, rgba(0, 180, 255, 0.13), transparent 27%),
        radial-gradient(circle at 75% 80%, rgba(151, 80, 255, 0.13), transparent 30%),
        linear-gradient(135deg, #020617 0%, #080b22 48%, #020617 100%);
}
...
.quantum-space::before {
    ...
    inset: 0;
    background-image:
        radial-gradient(circle at 4% 12%, rgba(255,255,255,.95) 0px, rgba(255,255,255,.55) 1px, transparent 2px),
        radial-gradient(circle at 11% 34%, rgba(180,210,255,.85) 0px, rgba(180,210,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 18% 70%, rgba(255,255,255,.9) 0px, rgba(255,255,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 26% 18%, rgba(200,180,255,.9) 0px, rgba(200,180,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 34% 43%, rgba(255,255,255,.85) 0px, rgba(255,255,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 43% 9%, rgba(190,210,255,.9) 0px, rgba(190,210,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 50% 72%, rgba(255,255,255,.9) 0px, rgba(255,255,255,.3) 1px, transparent 2px),
        radial-gradient(circle at 58% 27%, rgba(200,180,255,.95) 0px, rgba(200,180,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 66% 55%, rgba(255,255,255,.85) 0px, rgba(255,255,255,.3) 1px, transparent 2px),
        radial-gradient(circle at 73% 14%, rgba(180,220,255,.95) 0px, rgba(180,220,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 81% 39%, rgba(255,255,255,.9) 0px, rgba(255,255,255,.3) 1px, transparent 2px),
        radial-gradient(circle at 89% 74%, rgba(200,180,255,.9) 0px, rgba(200,180,255,.35) 1px, transparent 2px),
        radial-gradient(circle at 95% 22%, rgba(255,255,255,.9) 0px, rgba(255,255,255,.3) 1px, transparent 2px),
        radial-gradient(circle at 47% 53%, rgba(190,220,255,.85) 0px, rgba(190,220,255,.3) 1px, transparent 2px),
        radial-gradient(circle at 7% 84%, rgba(255,255,255,.9) 0px, rgba(255,255,255,.3) 1px, transparent 2px);
...
.quantum-space::after {
    ...
    inset: 0;
    background-image:
        radial-gradient(circle at 14% 24%, rgba(255,255,255,.7) 0px, transparent 1.8px),
        radial-gradient(circle at 22% 55%, rgba(160,190,255,.8) 0px, transparent 1.5px),
        radial-gradient(circle at 31% 78%, rgba(255,255,255,.7) 0px, transparent 1.5px),
        radial-gradient(circle at 39% 29%, rgba(190,170,255,.8) 0px, transparent 1.5px),
        radial-gradient(circle at 55% 17%, rgba(255,255,255,.8) 0px, transparent 1.5px),
        radial-gradient(circle at 63% 82%, rgba(170,210,255,.7) 0px, transparent 1.5px),
        radial-gradient(circle at 71% 48%, rgba(255,255,255,.7) 0px, transparent 1.5px),
        radial-gradient(circle at 78% 68%, rgba(200,180,255,.7) 0px, transparent 1.5px),
        radial-gradient(circle at 86% 30%, rgba(255,255,255,.75) 0px, transparent 1.5px);
    opacity: .65;
...
@keyframes starTwinkle {
    0% { opacity: .30; filter: brightness(.7); }
    50% { opacity: .95; filter: brightness(1.4); }
    100% { opacity: .45; filter: brightness(.9); }
}
...
section[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #030611, #070b1d, #02040c);
...
section[data-testid="stSidebar"] .stButton button {
    ...
    background: linear-gradient(135deg, rgba(18,25,53,.96), rgba(7,12,29,.96));
    color: #dbeafe;
...
.quantum-logo {
    ...
    text-shadow: 0 0 8px #ffffff, 0 0 20px rgba(139,92,246,1), 0 0 45px rgba(99,102,241,.9);
...
if audio_value is not None:
    if SPEECH_RECOGNITION_AVAILABLE:
        try:
            ...
            st.warning("I couldn't understand the audio recording.")
        except Exception as e:
            st.warning(f"Microphone transcription failed: {str(e)}")
    else:
        st.warning(
            "Microphone transcription requires the `speech_recognition` package."
        )


# =========================================================
# FINAL QUERY EXECUTION & RAG INTEGRATION
# =========================================================
