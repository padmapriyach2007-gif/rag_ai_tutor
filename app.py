...
div[data-testid="stHorizontalBlock"]:has(.composer-anchor) {
    ...
    box-shadow:
        ...
        0 0 20px rgba(108, 63, 255, 0.25) !important;
...
with st.sidebar:
    ...
    for chat_name in list(
        ...
        with menu_col:
            ...
            with st.popover(
                "⋮",
                help=f"Manage {chat_name}"
            ):

                st.markdown("**Manage Chat**")

                st.caption(chat_name)
        ...
        with rename_col1:
            ...
            if st.button(
                ...
                if not cleaned_name:
                    ...
                    and
                    cleaned_name in st.session_state.chats
                ):
...
if st.session_state.learning_mode:
    ...
    st.markdown(
        ...
        <div class="learning-panel">
            ...
            <div class="learning-subtitle">
                ...
                with short lessons, examples, and quizzes.
            </div>
    ...
    lessons = {
        ...
        "Quantum Computing Basics": {
            ...
            "intro":
                ...
                "ordinary bits, quantum computers use qubits.",
            ...
            "example":
                "Think of a classical bit like a switch "
                "that is OFF or ON. A qubit is described by "
                "a quantum state with amplitudes for |0⟩ and |1⟩.",

            "quiz": (
                "What is the basic information unit of a quantum computer?",
                [
                    "Byte",
                    "Qubit",
                    "Pixel",
        ...
        "Qubits & Superposition": {
            ...
            "intro":
                ...
                "information. Superposition allows its state "
                "to be represented as a combination of |0⟩ and |1⟩.",
            ...
            "example":
                "If α = 1/√2 and β = 1/√2, measuring the "
                "qubit in the computational basis gives "
                "0 or 1 with equal probability.",

            "quiz": (
                "What does measurement of a single qubit in the computational basis return?",
                [
                    "Only 0",
                    "Only 1",
                    "0 or 1",
        ...
        "Entanglement": {
            ...
            "intro":
                "Entanglement is a quantum correlation in "
                "which the joint state of multiple qubits "
            ...
            "example":
                "A Bell state such as "
                "(|00⟩ + |11⟩)/√2 produces strongly "
                "correlated measurement outcomes.",

            "quiz": (
                "Which concept describes strong quantum correlations between qubits?",
                [
                    "Compilation",
                    "Entanglement",
                    "Caching",
        ...
        "Quantum Gates": {
            ...
            "intro":
                ...
                "qubit states. They are represented "
                "mathematically by unitary matrices.",
            ...
            "example":
                "Starting with |0⟩, applying H produces "
                "(|0⟩ + |1⟩)/√2.",

            "quiz": (
                "Which gate is commonly used to create an equal superposition from |0⟩?",
                [
                    "X",
                    "H",
                    "Z",
        ...
        "Quantum Circuits": {
            ...
            "intro":
                ...
                "gates applied to qubits, followed by "
            ...
            "example":
                ...
                "and then measure. Repeating it produces "
                "approximately half 0s and half 1s ideally.",

            "quiz": (
                "What usually comes at the end of a quantum circuit to obtain classical information?",
                [
                    "Measurement",
                    "Compression",
                    "Encryption",
        ...
        "Measurement": {
            ...
            "intro":
                "Measurement converts quantum information "
                "into classical information and generally "
            ...
            "example":
                "For (|0⟩ + |1⟩)/√2, an ideal computational-basis "
                "measurement returns 0 or 1 with 50% probability each.",

            "quiz": (
                "What determines the probability of observing a basis state?",
                [
                    "Amplitude squared",
                    "Amplitude sign only",
                    "Number of gates only",
                    "Circuit color"
                ],
                "Amplitude squared"
            )
        ...
        "Grover's Algorithm": {
            ...
            "intro":
                ...
                "speedup for searching an unstructured space "
                "compared with the standard classical "
                "black-box search model.",
            ...
            "example":
                "A classical search may require O(N) oracle "
                "queries in the worst case, while Grover's "
                "algorithm requires O(√N) queries.",

            "quiz": (
                "What is the ideal query complexity of Grover's search for N items?",
                [
                    "O(N²)",
                    "O(N)",
                    "O(√N)",
        ...
        "Shor's Algorithm": {
            ...
            "intro":
                ...
                "integer factoring and related number-theoretic "
                "problems, using a quantum period-finding procedure.",
            ...
            "example":
                "The algorithm can transform a factoring problem "
                "into a period-finding problem that can be processed "
                "using quantum interference and the quantum Fourier transform.",

            "quiz": (
                "Which transform is a major component of Shor's algorithm?",
                [
                    "Fast Fourier Transform only",
    ...
    completed = sum(
        ...
        if st.session_state.learning_progress.get(topic)
    )

    st.progress(
        completed / len(learning_topics),
        text=(
            f"Learning progress: "
            f"{completed}/{len(learning_topics)} topics completed"
        )
    )

    st.info(
        "💬 Use the chat box below to ask the AI Tutor "
        "for a simpler explanation, examples, equations, "
        "or practice questions about the selected topic."
    )
...
# ============================================================
# STAGED ATTACHMENTS / VOICE DISPLAY
# ============================================================
...
if prompt:
    ...
    # Clear staged content after sending
    st.session_state.staged_attachments = []
